...
turtles-own [energy accuracy attackRange damage fireRate moveSpeed]
...
to setup-attackers
  create-attackers number [ setxy random-xcor -25 set color red set heading 0 set energy 50 set accuracy 0.8 set attackRange 10 set damage 10]
end
...
to move-defenders
  ask defenders[
    ifelse count attackers in-radius attackRange >= 1 [
      set color 108
      ask min-one-of attackers [distance myself ] [set energy energy - 5]
    ]
    [
